...
local sector10 = tab3:CreateSector("Basic Utils","left")
local sector11 = tab3:CreateSector("Anticheat Disabler","right")
...
sector11:AddButton("Disabler Toggle", function()
end)


sector10:AddButton("Antifling", function()
	loadstring(game:HttpGet"https://pastebin.com/raw/x21yzF3Q")()
end)
...
sector10:AddButton("Serverhop", function()
